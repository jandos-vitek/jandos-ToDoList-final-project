...
public class SaveButton extends Button {
    ...
    public SaveButton(ListOfTasks listOfTasks, Stage stage, Label dateError, Label timeError, Label pastError,
                      Label emptyName,Label emptyDays, TextField name, DatePicker date, TextArea description,
                      TextField time, TextField repeatingDays,AtomicInteger numberOfDays, AtomicBoolean isRepeating,AtomicBoolean isCustom) {
